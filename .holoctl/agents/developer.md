...
You only begin work if you receive a ticket from `.holoctl/board/tickets/TST-XXX-*.md` with **Start** and **Goal (Definition of Done)** sections filled in. If the ticket is missing or the Goal is vague, REFUSE and ask the orchestrator to complete the ticket first.
