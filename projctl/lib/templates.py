...
def get_templates(config: dict) -> dict[str, str]:
    ...
    return {
        ".projctl/board/WORKFLOW.md": _workflow_md(config),
        ".projctl/board/tickets/_template.md": _ticket_template_md(config),
        ".projctl/agents/developer.md": _agent_developer_md(p),
        ".projctl/agents/reviewer.md": _agent_reviewer_md(p),
        ".projctl/agents/architect.md": _agent_architect_md(p),
        ".projctl/agents/researcher.md": _agent_researcher_md(p),
        ".projctl/commands/status.md": _cmd_status_md(cli, p),
        ".projctl/commands/ticket.md": _cmd_ticket_md(cli, p),
        ".projctl/commands/board.md": _cmd_board_md(cli, p),
        ".projctl/commands/sprint.md": _cmd_sprint_md(cli),
        ".projctl/commands/decision.md": _cmd_decision_md(),
        ".projctl/commands/close.md": _cmd_close_md(cli, p),
        ".projctl/context/objective.md": _context_objective_md(p),
        ".projctl/context/architecture.md": _context_architecture_md(p),
        ".projctl/context/conventions.md": _context_conventions_md(p),
        ".projctl/instructions.md": _instructions_md(config),
    }
