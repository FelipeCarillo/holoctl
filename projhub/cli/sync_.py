...
_SYNC_TARGETS = {
    ".projhub/commands/status.md",
    ".projhub/commands/ticket.md",
    ".projhub/commands/board.md",
    ".projhub/commands/sprint.md",
    ".projhub/commands/decision.md",
    ".projhub/commands/close.md",
    ".projhub/board/WORKFLOW.md",
}
...
def sync_cmd(
    ...
    """Update template-managed files in .projhub/ after a projhub upgrade."""
    ...
    if include_agents:
        for key in templates:
            if key.startswith(".projhub/agents/"):
                targets.add(key)

    console.print(f"\n  [bold]projhub sync[/bold]\n")
    ...
    if not dry_run:
        ...
        console.print("  Run [dim]projhub compile[/dim] to push changes to your AI tool.\n")
    else:
